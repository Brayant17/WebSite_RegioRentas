// Crear el tipo Property con los campos necesarios para el formulario, incluyendo los campos básicos, detalles, ubicación, características, etc. Este tipo se usará para manejar el estado de la propiedad en el formulario y para enviar los datos al backend al guardar la propiedad.
