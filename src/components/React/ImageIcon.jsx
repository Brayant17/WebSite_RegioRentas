export default function ImageIcon({ children, type, activeType, onClick }) {
    ...
    return (
        <div onClick={onClick} className={`flex flex-col items-center border-b-2 hover:border-neutral-900  hover:opacity-100 cursor-pointer h-full ${style} duration-400`}>
            {children}
        </div>
    )
